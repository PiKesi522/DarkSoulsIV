...
public class BossEvent : MonoBehaviour
{
    ...
    public void injury(float cost){
        ...
        AM.transform.Find("SoundEffect").GetComponent<AudioSoundEffect>().AudioPlayAttack();
        if(HP < 0.1f){
            bossDead = true;
            PlayerGetMoney(5000);
            ...
            // UI播放Boss死亡动画
            UI.transform.Find("BossDefeat/TextHighlight").GetComponent<DeathUI>().playBossDefeatAnimation();
            UI.transform.Find("BossDefeat/Text").GetComponent<DeathUI_Text>().playBossDefeatAnimation();
            Invoke("removeUI", 3f);
        }
    }

    private void removeUI(){
        UI.transform.Find("BossDefeat/TextHighlight").GetComponent<DeathUI>().stopBossDefeatAnimation();
        UI.transform.Find("BossDefeat/Text").GetComponent<DeathUI_Text>().stopBossDefeatAnimation();
    }
