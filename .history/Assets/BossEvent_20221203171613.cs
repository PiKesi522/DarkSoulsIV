...
public class BossEvent : MonoBehaviour
{
    ...
    private void removeUI(){
        UI.transform.Find("BossDefeat/TextHighlight").GetComponent<DeathUI>().playDeathAnimation();
        UI.transform.Find("BossDefeat/Text").GetComponent<DeathUI_Text>().playDeathAnimation();
    }
