...
public class NPCevent : MonoBehaviour
{
    ...
    public float HPbarLeft;
    public float HPbarRight;
    ...
    void Awake()
    {
        ...
        HPbarLeft = canvas.transform.GetComponentsInChildren<Slider>()[0].value;
        HPbarRight = canvas.transform.GetComponentsInChildren<Slider>()[1].value;
        HPbarLeft = 100f;
        HPbarRight = HPbarLeft;
