...
public class CharacterState : MonoBehaviour
{
    ...
    void Start()
    {
        this.endurance = GameObject.Find("Endurance");
    ...
    void recoveryEndurance(){
        this.endurance.GetComponent<Slider>().value = this.endurance.GetComponent<Slider>().value + 5;
    }

    void decreaseEndurance(int value){
        this.endurance.GetComponent<Slider>().value = this.endurance.GetComponent<Slider>().value - value;
    }
}
