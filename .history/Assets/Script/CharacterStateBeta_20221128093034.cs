...
public class CharacterStateBeta : MonoBehaviour
{
    ...
    void Start(){
        healthBar = this.transform.parent.Find("Canvas/PlayerElite/Bars/HealthBar").gameObject;
        healthBar.GetComponent<Image>().fillAmount = 1.0f;
        manaBar = this.transform.parent.Find("Canvas/PlayerElite/Bars/ManaBar").gameObject;
