...
public class LevelAndMoney : MonoBehaviour
{
    ...
    public void tryLevelUP(){
        if(money >= LevelUPMoney){
            ...
            this.gameObject.GetComponent<CharacterStateBeta>().playerHPMax = 150f + 5f * level; 
            this.gameObject.GetComponent<CharacterStateBeta>().playerEnduranceMax = 150f + 10f * level;
            this.gameObject.GetComponent<CharacterStateBeta>().recoveryHP(playerHPMax);
            this.gameObject.GetComponent<CharacterStateBeta>().recoveryEndurance(playerEnduranceMax);
        }
    }    
