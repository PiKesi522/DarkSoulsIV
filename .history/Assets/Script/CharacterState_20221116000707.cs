...
public class CharacterState : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _weapon = GameObject.Find("myWeapon");
        _weapon.GetComponent<Attacker>().enabled = false;
        ...
        if(Input.GetMouseButtonDown(0)){
            ...
            if(readyToAttack){
                ...
                if(hasEnoughEndurance(newCost)){
                    _weapon.GetComponent<Attacker>().enabled = true;    
    ...
    void disableAttacker(){
        _weapon.GetComponent<Attacker>().active = false;    
    }
}
