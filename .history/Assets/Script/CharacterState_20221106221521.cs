...
public class CharacterState : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        this.recoveryEnduranceSpeed = 0.3f;
        ...
        if(Input.GetMouseButtonDown(0)){
            ...
            if(motionInterval < 0.1f){
                ...
                if(hasEnoughEndurance(attackEnduranceCost)){
                    ...
                    if(animator.GetInteger("MotionState") >= (int)(motionState.useLeftHand_Attack1) && 
                       animator.GetInteger("MotionState") < (int)(motionState.useRightHand_Defend) ){
                        Debug.Log(animator.GetInteger("MotionState"));
