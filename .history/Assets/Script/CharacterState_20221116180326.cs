...
public class CharacterState : MonoBehaviour
{
    ...
    void playDeathAnimation(){
        ...
        GameObject background = gameOver.transform.GetChild(0);
        GameObject textHighlight = gameOver.transform.GetChild(1);
        GameObject text = gameOver.transform.GetChild(2);
        Debug.Log(background);
        Debug.Log(textHighlight);
        Debug.Log(text);
    }
