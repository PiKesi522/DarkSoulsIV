...
namespace RPGCharacterAnims
{
	...
	public class CameraController:MonoBehaviour
	{
		...
		private void Update()
		{
			...
			if(cameraTarget.transform.parent.gameObject.GetComponent<RPGCharacterInputController>().HasAimInput()) {
				Debug.Log(cameraTarget.transform.parent.transform.position);
				Debug.Log(cameraTarget.transform.position);
                float newDistance = (cameraTarget.transform.parent.transform.position - cameraTarget.transform.position).magnitude;
