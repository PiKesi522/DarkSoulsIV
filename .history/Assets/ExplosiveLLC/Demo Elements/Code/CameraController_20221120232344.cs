	...
	public class CameraController:MonoBehaviour
	{
		...
		private void Update()
		{
			...
			if(player.GetComponent<RPGCharacterInputController>().HasAimInput()) {
				...
				pos.x = player.transform.position.x - 4f / 360f * Mathf.Sin(player.transform.rotation.eulerAngles.y);
				pos.y = player.transform.position.y + 4f / 360f * Mathf.Cos(player.transform.rotation.eulerAngles.y);
				Debug.Log(pos);
