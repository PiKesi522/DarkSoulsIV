...
namespace RPGCharacterAnims
{
    public class GUIControls : MonoBehaviour
    {
		...
		private void Idle()
		{
			...
			rpgCharacterController.animator.SetFloat(AnimationParameters.Idle, 0.5f);
		}
		...
		public void handleKnockBack(){
			isKnockBack = true;
			Invoke("recoverKnock",0.1f);
		}
		void recoverKnock(){
			isKnockBack = false;
		}
		private bool isKnockDown = false;
		public void handleKnockDown(){
			isKnockDown = true;
		}
		private bool knockBackSeq = false;
		private void Damage()
        {
