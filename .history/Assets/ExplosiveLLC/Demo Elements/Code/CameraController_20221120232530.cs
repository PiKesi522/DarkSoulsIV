	...
	public class CameraController:MonoBehaviour
	{
		...
		private void Update()
		{
			...
			if(player.GetComponent<RPGCharacterInputController>().HasAimInput()) {
				...
				pos.x = transform.position.x - 20f / 360f * Mathf.Sin(player.transform.rotation.eulerAngles.y);
				pos.z = transform.position.z + 20f / 360f * Mathf.Cos(player.transform.rotation.eulerAngles.y);
				Debug.Log(pos);
