...
namespace RPGCharacterAnims
{
    ...
    public class RPGCharacterController : MonoBehaviour
    {
        ...
        {
			Debug.Log(this.gameObject.GetComponent<RPGCharacterInputController>().HasAimInput());

            if(this.gameObject.GetComponent<RPGCharacterInputController>().HasAimInput()){
                this.gameObject.GetComponent<RPGCharacterInputController>().SetAimInput(false);
			    // Debug.Log(this.gameObject.GetComponent<RPGCharacterInputController>().HasAimInput());
                ...
                SetIKPause(1.05f);
                Invoke("RecoverAim", 1f);
                // this.gameObject.GetComponent<RPGCharacterInputController>().SetAimInput(true);
            }
            else{
