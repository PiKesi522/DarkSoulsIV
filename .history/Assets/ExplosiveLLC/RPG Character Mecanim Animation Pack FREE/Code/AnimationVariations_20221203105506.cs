...
namespace RPGCharacterAnims
{
    ...
    public class AnimationVariations
    {
        ...
        public static readonly TwoHandedSwordAttack[] TwoHandedSwordLightAttacks =
        {
            TwoHandedSwordAttack.Attack1, TwoHandedSwordAttack.Attack2, TwoHandedSwordAttack.Attack3,
            TwoHandedSwordAttack.Attack4, TwoHandedSwordAttack.Attack5,
            TwoHandedSwordAttack.Attack6, TwoHandedSwordAttack.Attack7, TwoHandedSwordAttack.Attack8, 
        };

        public static readonly TwoHandedSwordAttack[] TwoHandedSwordHardAttacks =
        {
            TwoHandedSwordAttack.Attack9, TwoHandedSwordAttack.Attack10, TwoHandedSwordAttack.Attack11
        };
